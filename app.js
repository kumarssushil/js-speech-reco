...
function readoutloud(message){
    ...
    if(message.includes('Jarvis')){
        const finaltext = 'bhosdike madhar chod behen chod beti chod behen chod beti chod Lund Ab bol na madhar chod ah aha aha ha ha aaooh oh ah ahahaha aha fuck me fast fuuuuuuckkk fuck fuck';
        speech.text = finaltext;
    }
